...
const resetAppcues = () => {
  // resets the session and removes user information from local storage
  ...
  return (
    <div id="toolbar">
      ...
      <ul>
        ...
        <li>
          <button onClick={clearShow}>Appcues.clear()</button>
        </li>
        <li>
          <button onClick={anonymousUser}>Appcues.anonymous()</button>
        </li>
        <li>
          <button onClick={openDebugger}>Appcues.debug()</button>
        </li>
        <li>
          <button onClick={resetAppcues}>Appcues.reset()</button>
        </li>
      </ul>
      <EventLog />
    </div>
