...
function EventLog() {
  const clearLog = () => {
    // removes all listed events in the event log
...
function logEvents(name, payload) {
  // function to log Appcues events on the page
...
const parseData = (data) => {
  // function to format event data into HTML-readable format
