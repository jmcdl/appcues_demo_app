...
const setTimestamp = () => {
  // sets user's signup date to current time;
...
const SetProperties = () => {
  return (
    <div className="property-setter">
      <p>
        If you'd like to set the user's signupDate property to current time, you
        can use this button:
      </p>
      <button onClick={setTimestamp}>Set New Signup Date</button>
      <p>
        If you'd like to set a custom signup date, enter below. Make sure you
        use a UNIX timestamp.
        <br />
        <a href="https://www.epochconverter.com/">Epoch Converter</a> can help
        you generate one.
      </p>
