...
const Contact = () => {
  return (
    <div className="app-content">
      <h1>Contact Us</h1>
      <p>
        If you have any questions about this app, feel free to send your
      ...
      <p>
        For any questions about Appcues, check out{" "}
        <a href="https://appcues.com">Appcues.com</a>
      </p>
      <p>
        <a href="https://docs.appcues.com/">The Appcues docs</a> are also a
        great resource.
      </p>
    </div>
  );
